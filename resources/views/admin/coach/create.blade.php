...
<fieldset class="container">
    ...
    <div class="row">
        ...
        <div class="form-group col">
            <label for="passcoach" class="form-label">Password</label> 
            <input type="password" class="form-control  @error('passcoach') is-invalid @enderror" placeholder="Password" value="{{ old('passcoach') }}"  aria-label="Spécialité" aria-describedby="basic-addon1"  name="passcoach" id="passcoach">
            @error('passcoach')<div class="text-danger">{{ $message }}</div>@enderror
        </div>
    </div>
    <div class="row">
     <div class="form-group col">
